...
var Logo = function (_a) {
    ...
    var innerLogo = (
        ...
        React.createElement("img", {src:"./logo.png" ,className: "desktop-icon", isDark: isDark }));
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement("img", { src:"./logo.png"}, )) : (React.createElement(StyledLink, { to: href, "aria-label": "Pancake home page" }, innerLogo))));
};
