        ...
        <div className="col-md-5 p-0 heading">
          ...
          <AppBody>
            <Wrapper id="swap-page">
              ...
              />
              <PageHeader
                title={TranslateString(8, 'Exchange Crypto')}
                  ...
                  <CurrencyInputPanel
                    label={
                      independentField === Field.OUTPUT && !showWrap && trade
                        ? TranslateString(194, 'You Send (estimated)')
                        : TranslateString(76, 'You Send')
                    }
                  ...
                  <CurrencyInputPanel
                    label={
                      independentField === Field.INPUT && !showWrap && trade
                        ? TranslateString(196, 'You Get (estimated)')
                        : TranslateString(80, 'You Get')
                    }
