...
describe('utils', () => {
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0x3E2b14680108E8C5C45C3ab5Bc04E01397af14cB')).toBe('0x3E2b14680108E8C5C45C3ab5Bc04E01397af14cB')
      expect(isAddress('0x3E2b14680108E8C5C45C3ab5Bc04E01397af14cB')).toBe('0x3E2b14680108E8C5C45C3ab5Bc04E01397af14cB')
    })
    ...
    it('fails if too long', () => {
      expect(isAddress('0x3E2b14680108E8C5C45C3ab5Bc04E01397af14cB')).toBe(false)
    })
  })
  ...
  describe('#shortenAddress', () => {
    ...
    it('truncates middle characters', () => {
      expect(shortenAddress('0x3E2b14680108E8C5C45C3ab5Bc04E01397af14cB')).toBe('0xf164...b92a')
    })
